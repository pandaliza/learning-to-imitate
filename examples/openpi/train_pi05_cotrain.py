...
def main():
    ...
    if aux_intent:
        ...
        pass  # M8 head is built after ds exists (needs the eef/intent-target dim); slot stack unused
    else:
        cotrain.train()
    ...
    while step < args.steps:
        ...
        for batch in loader:
            ...
            elif aux_intent or align_intent or wsm_intent:
                # M4/M5/M8: NO conditioning of the action head. The aux head / REPA projector / wsm head
                # reads a tap from the SAME action forward (one pass -> vanilla DDP).
            ...
            elif align_intent or wsm_intent:
